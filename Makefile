...
IPFSLOCAL="http://localhost:8080/openbazaar/"
IPFSGATEWAY="https://gateway.ob1.io/ipfs/"
NPM=npm
...
resources: openbazaar-theme packages
...
dev: css
	$(PREPEND)( \
		...
		$(HUGO_BINARY) server -w --port $(PORT) --bind 0.0.0.0 --verbose \
	)
